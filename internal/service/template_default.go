...
func (t *DefaultTemplate) addTotals(m core.Maroto, data *InvoiceData, lang i18n.Lang) {
	...
	m.AddRow(6,
		col.New(8),
		col.New(2).Add(text.New(i18n.TForLang(lang, "pdf.subtotal"), rightStyle)),
		col.New(2).Add(text.New(formatMoneyDefault(data.Invoice.Subtotal, data.Invoice.Currency), rightStyle)),
	)
	m.AddRow(6,
		col.New(8),
		col.New(2).Add(text.New(i18n.TForLang(lang, "pdf.vat_total"), rightStyle)),
	...
	m.AddRow(8,
		col.New(8),
		col.New(2).Add(text.New(i18n.TForLang(lang, "pdf.total"), rightBold)),
...
func (t *DefaultTemplate) vatPayerText(isVATPayer bool, lang i18n.Lang) string {
	...
	return i18n.TForLang(lang, "pdf.not_vat_payer")
}
